...
from cougar.data import transforms as T
...
class VOCDetectionDataset(VOCDetection):
    def __init__(self, img_folder, year, image_set, transforms):
        super(VOCDetectionDataset, self).__init__(img_folder,  year, image_set)
...
def get_voc(root: str, image_set: str, transforms):
    ...
    dataset = VOCDetectionDataset(img_folder=root, year=year, image_set=image_set, transforms=transforms)
